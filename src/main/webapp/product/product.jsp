...
<body>
  <%
    ClientEntity user = (ClientEntity) ((LoginCredentialsEntity) session.getAttribute(SessionKeys.LOGIN_CREDENTIALS)).getUser();
    ...
    <div class="p-2">
      <form method="get" action="productslist">
        <button type="submit" class="btn btn-labeled btn-light">
          <span class="btn-label"><i class="bi bi-arrow-left"></i></span>Volver</button>
      </form>
    </div>
